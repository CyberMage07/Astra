...
def test_orchestrator_runs_pe_pipeline(
    ...
    results = (
        ...
        _completed_result("resources"),
        _completed_result("overlay"),
        _completed_result("tls"),
        _completed_result("signature"),
        _completed_result("versioninfo"),
        _completed_result("richheader"),
        _completed_result("debug"),
        _completed_result("metadata"),
        _completed_result("loadconfig"),
        _completed_result("imports"),
        _completed_result("packer"),
        _completed_result("exports"),
        _completed_result("importdirectories"),
        _completed_result("relocations"),
        _completed_result("dotnet"),
        _completed_result("manifest"),
        _completed_result("fingerprints"),
    )
    ...
    assert len(report.analyzer_results) == 23
    assert report.completed_analyzers == 23
    assert report.failed_analyzers == 0
    assert report.findings == (finding,)
    assert len(report.analyzer_executions) == 23
